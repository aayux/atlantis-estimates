...
q2 = 363369694572014600293 #chosen as next prime to ceil(lb/q) such that it is congruent to 5 mod 8
...
iss_tok = {'d': 128, #ring dimension
              ...
              'm1': 4, # m1
              'm2': 58, # m2 - n+{0,1,2}*(256/d+1)+lamb/2+ell determines LWE hardness
              'q': q_ZK, # ZK modulus
              'lambda': 10,
