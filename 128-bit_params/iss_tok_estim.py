...
q2 = 381020740855544781410926877 #chosen as next prime to ceil(lb/q) such that it is congruent to 5 mod 8
...
iss_tok = {'d': 128, #ring dimension
              'n': 17, # determines SIS hardness
              'm1': 4, # m1
              'm2': 73, # m2 - n+{0,1,2}*(256/d+1)+lamb/2+ell determines LWE hardness
              'q': q_ZK, # ZK modulus
              'lambda': 10,
